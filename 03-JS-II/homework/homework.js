...
function esVerdadero(valor){
  ...
  return valoresBool(valor);
}

function valoresBool(valorQueRecibe){
  return  ((valorQueRecibe) ?  "Soy verdadero" : "Soy falso")
}
...
function doWhile(numero) {
  ...
  return automentarValor(numero)
}

function automentarValor(valor){
  let i = 0;
  do{
     i = i + 1;
    valor = valor + 5;
